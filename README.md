...
- **Re-extraction is reproducible offline**: `--offline` re-runs a record from the committed caches and aborts on any cache miss instead of calling an API (section 10.8.2).
