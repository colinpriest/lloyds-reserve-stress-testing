...
def build_verification_prompt(field, gemini_value, gpt_value, syndicate_num, report_year):
    ...
    if field == "direction":
        return (
            ...
            f"(a P&L accounting item: claims paid in the year plus the change in the gross claims "
            f"provision, over every underwriting year), NOT the prior-year reserve movement. "
            f"IGNORE IT COMPLETELY.\n"
